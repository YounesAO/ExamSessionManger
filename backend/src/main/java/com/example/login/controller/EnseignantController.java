...
public class EnseignantController {
    ...
    // Fetch enseignants by department ID
    @GetMapping("/search/departement/{id}")
    public ResponseEntity<List<Enseignant>> getAllByDepartementId(@PathVariable Long id) {
        List<Enseignant> enseignants = enseignantService.getAllByDepartementId(id);
